    ...
    <section id="about" className="border-x border-zinc-900/50 max-w-7xl mx-auto border-b border-zinc-800">
      <div className="flex justify-center py-40 bg-[#050505]">
        <div className="max-w-2xl px-6 text-center">
          <span className="font-sans text-[10px] text-zinc-600 block mb-12 uppercase tracking-[0.8em]">02 / Philosophy</span>
          <h2 className="font-serif text-5xl md:text-7xl leading-none italic mb-20">
            Design is the <br />
            <span className="text-zinc-500 underline underline-offset-8">silent ambassador</span> <br />
            of your brand.
          </h2>
